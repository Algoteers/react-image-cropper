    ...
    return (
      <ul>
        ...
        <li>
          ...
          <h4>after crop</h4>
          {this.state.image1 ? (
            <img width='200' src={this.state.image1} alt='' />
          ) : null}
        </li>
        <li>
          ...
          <h4>after crop</h4>
          {this.state.image2 ? (
            <img width='200' src={this.state.image2} alt='' />
          ) : null}
        </li>
        <li>
          <h3>Disabled</h3>
        ...
        <li>
          ...
          <Cropper
            src={'404.jpg'}
            ref='image5'
            imageLoadError={this.OnImageLoadError}
          />
        </li>
        <li>
          <h3>
            Variable width and height, cropper frame is relative to natural
            image size, don't allow new selection, set custom styles
          </h3>
          ...
          <h4>after crop</h4>
          {this.state.image4 ? (
            <img width='200' src={this.state.image4} alt='' />
          ) : null}
        </li>
      </ul>
    )
...
export default hot(module)(ImageCropDemo)
